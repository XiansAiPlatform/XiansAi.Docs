...
- [ ] 1.5 Send a PR to the [documentation repository](https://github.com/XiansAiPlatform/XiansAi.Docs) to improve documentation
...
- [ ] 5.6 Review tasks in the [XiansAI Platform project board](https://github.com/orgs/XiansAiPlatform/projects/4). Pick up a task and contribute to platform development
